...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="shadow-md py-4 px-8 lg:px-20 flex justify-between items-center sticky top-0 z-50">
            {/* Brand Name */}
            <a href="#" className="text-2xl font-bold text-indigo-600">Portfolio.</a>

            {/* Desktop Navigation Links */}
            <ul className="hidden lg:flex items-center gap-8">
                <li><Link href="#home" className="text-lg text-gray-700 hover:text-indigo-600">Home</Link></li>
                <li><Link href="#about" className="text-lg text-gray-700 hover:text-indigo-600">About</Link></li>
                <li><Link href="#services" className="text-lg text-gray-700 hover:text-indigo-600">Services</Link></li>
                <li><Link href="#projects" className="text-lg text-gray-700 hover:text-indigo-600">Projects</Link></li>
                <li><Link href="#skills" className="text-lg text-gray-700 hover:text-indigo-600">Skills</Link></li>
            </ul>
